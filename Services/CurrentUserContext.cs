...
public interface ICurrentUserContext{long UserId{get;}long StoreId{get;}string Name{get;}string Role{get;}}
public sealed class CurrentUserContext(IHttpContextAccessor accessor):ICurrentUserContext
{
 ...
 public long UserId=>Parse(ClaimTypes.NameIdentifier,"usuario");public long StoreId=>Parse("store_id","sucursal");public string Name=>User.Identity?.Name??"Sistema";public string Role=>User.FindFirstValue(ClaimTypes.Role)??"";
