...
try{
    ...
    $config=@{ConnectionStrings=@{AtlasMySql="Server=127.0.0.1;Port=3306;Database=atlas_pos;User=atlas_app;Password=$databasePassword;Allow User Variables=true;"};Atlas=@{InitialAdminPassword=$adminPassword;DemoMode=$false;Currency='MXN';TimeZone='America/Mexico_City';RequireHttps=$false}}|ConvertTo-Json -Depth 5
